...
export type QuestionCategory =
  | 'behavioural'   // STAR-format — past behaviour predicts future
  | 'technical'     // role-specific knowledge / skills
  | 'situational'   // hypothetical scenarios
  | 'motivation'    // why this role / company / career
  | 'strength_gap'; // strength & weakness / self-awareness

export interface InterviewQuestion {
  id:              string;
  category:        QuestionCategory;
  question:        string;
  intent:          string;   // what the interviewer is really testing
  suggestedAnswer: string;   // personalised to the resume — 3-5 sentences
  keyPoints:       string[]; // 3 bullet points the answer should hit
  tips:            string[]; // 2-3 improvement tips specific to this question
